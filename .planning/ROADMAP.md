...
**Success Criteria** (what must be TRUE):
  ...
  5. Postgres RLS is enabled at the cluster level and `app.current_household_id` session variable is reserved (policies still inactive — Phase 1 activates them); structured JSON logging via `structlog` is wired with request_id and sensitive-field redaction
**Plans:** TBD
...
|-------|----------------|--------|-----------|
| 0. Repo Skeleton | 0/TBD | Not started | - |
